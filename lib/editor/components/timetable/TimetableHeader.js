      ...
      <div
        ...
        <Row style={{ marginTop: '5px' }}>
          <Col sm={12}>
            <Button 
              bsStyle="info" 
              onClick={() => this.setState({showHelpText: true})}
              style={{marginBottom: "10px"}}
              >
              Diferencias entre esta herramienta y la especificación GTFS
              <span style={{
        ...
        <Modal
          show={this.state.showHelpText}
          onHide={() => this.setState({showHelpText: false})}
          bsSize="large"
          >
          <Modal.Header closeButton>
            <Modal.Title>Diferencias entre esta herramienta y la especificación GTFS</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
              Esta herramienta ha sido diseñada para trabajar en conjunto con las especificaciones del GTFS, pero existen algunas diferencias clave que debes tener en cuenta:
            </p>
            <ul>
              <li>
                <strong>Identificadores de Viaje ("Trip ID"):</strong> Mientras que GTFS permite múltiples frecuencias o calendarios que duplican el "Trip ID", esta herramienta maneja un único "Trip ID" por ruta, calendario y frecuencia para mantener la integridad de los datos.
              </li>
              <li>
                <strong>Diferencias al exportar tu GTFS:</strong> Al exportar tu GTFS la herramienta creara un nuevo "Trip" por cada frecuencia que hayas agregado.
              </li>
              {/* <li>
                <strong>Recomendaciones:</strong>
                <ol>
                  <li>Al agregar nuevas frecuencia nombra el "Trip ID" de la siguiente manera: "&lt;Nombre de la ruta&gt; - &lt;Nombre del calendario&gt; - &lt;Identificador&gt;". Ejemplos:</li>
                  <ul>
                    <li>L1 Guaymas Norte - Sabado - mañana</li>
                    <li>L1 Guaymas Norte - Sabado - tarde</li>
                    <li>L1 Guaymas Norte - Sabado - noche</li>
                  </ul>
                </ol>
              </li> */}
              <li>
                <strong>Compatibilidad Futura:</strong> Continuamos trabajando para mejorar la compatibilidad con GTFS y agradecemos cualquier feedback que puedas proporcionarnos.
              </li>
              <li>
                Para mayor información de como utilizar esta sección, mira nuestro video sobre <a href='https://conveyal-video-resources.s3.amazonaws.com/Calendarios+-+Tarifas+y+Horarios.mp4' target='_blank'>Calendarios, Tarifas y Horarios.</a>
                <div style={{textAlign: "center", width: "100%"}}>
                  <video width="380" height="210" controls>
                    <source src="https://conveyal-video-resources.s3.amazonaws.com/Calendarios+-+Tarifas+y+Horarios.mp4" type="video/mp4" />
          ...
          <Modal.Footer>
            <p style={{textAlign: "center"}}>
              Para más información o asistencia, no dudes en consultar nuestra documentación o contactarnos directamente.
            </p>
          </Modal.Footer>
        </Modal>
      </div>
