...
type State = {
  ...
  width: number,
  showMultipleFrecuenciesSameCalendarExample: boolean
}
...
export default class TimetableEditor extends Component<Props, State> {
  ...
  state = {
    ...
    showHelpModal: false,
    width: 1280,
    showMultipleFrecuenciesSameCalendarExample: false
  }
  ...
  addExampleRows = () => {
    const {addNewTrip, activePatternId, route, timetable, activeSchedule} = this.props
    
    console.log({activeSchedule})

    this.setState({showMultipleFrecuenciesSameCalendarExample: true})
  }
    ...
    return (
      <div
        ...
        <TimetableHeader
          ...
          {...this.props} />
        {
          (activeSchedule && !this.state.showMultipleFrecuenciesSameCalendarExample) && 
          <div style={{marginTop: "20px"}}>
            <Button onClick={() => {this.setState({showMultipleFrecuenciesSameCalendarExample: true})}} bsStyle="primary" style={{ marginBottom: "20px" }}>
              Mostrar ejemplo de multiples frecuencias
            </Button>
          </div>
        }
        {
          (activeSchedule && this.state.showMultipleFrecuenciesSameCalendarExample) && 
          <div style={{backgroundColor: "#5bc0de", padding: "8px", marginBottom: "20px", marginTop: "20px"}}>
            <Button onClick={() => {this.setState({showMultipleFrecuenciesSameCalendarExample: false})}} bsStyle="primary" style={{ marginBottom: "20px" }}>
              Esconder ejemplo de multiples frecuencias
            </Button>

            <p>
              En el siguiente ejemplo se muestra la ruta <strong>{this.props.route.route_long_name}</strong> 
              {' '}con 3 diferentes frecuencias a lo largo de los días especificados en el calendario 
              {' '}<strong>{this.props.activeSchedule.description}</strong>. 
              Podemos ver en el ejemplo que la ruta tiene viajes:
              <ul>
                <li>Cada 10 minutos por la mañana (05:00:00 - 07:59:00)</li>
                <li>Cada 6 minutos durante el día (08:00:00 - 19:59:00)</li>
                <li>Cada 10 minutos por la noche  (20:00:00 - 22:59:00)</li>
              </ul>
            </p>
            <p>Ejemplo:</p>
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', fontSize: "smaller" }}>
              <thead>
                <tr style={{ backgroundColor: '#f0f0f0' }}> {/* Background color for header */}
                  <th style={{ textAlign: 'center', paddingTop: "4px", paddingBottom: "4px", border: '1px solid #dddddd' }}>Block ID</th>
                  <th style={{ textAlign: 'center', paddingTop: "4px", paddingBottom: "4px", border: '1px solid #dddddd' }}>Trip ID</th>
                  <th style={{ textAlign: 'center', paddingTop: "4px", paddingBottom: "4px", border: '1px solid #dddddd' }}>Trip Headsign</th>
                  <th style={{ textAlign: 'center', paddingTop: "4px", paddingBottom: "4px", border: '1px solid #dddddd' }}>Trip Short Name</th>
                  <th style={{ textAlign: 'center', paddingTop: "4px", paddingBottom: "4px", border: '1px solid #dddddd' }}>Start time</th>
                  <th style={{ textAlign: 'center', paddingTop: "4px", paddingBottom: "4px", border: '1px solid #dddddd' }}>End time</th>
                  <th style={{ textAlign: 'center', paddingTop: "4px", paddingBottom: "4px", border: '1px solid #dddddd' }}>Headway</th>
                </tr>
              </thead>
              <tbody>
                <tr style={{ backgroundColor: 'white' }}>
                  <td style={{ border: '1px solid #dddddd' }}>&nbsp;</td>
                  <td style={{ border: '1px solid #dddddd' }}>{this.props.route.route_long_name} - {this.props.activeSchedule.description} - Mañana</td>
                  <td style={{ border: '1px solid #dddddd' }}>&nbsp;</td>
                  <td style={{ border: '1px solid #dddddd' }}>&nbsp;</td>
                  <td style={{ border: '1px solid #dddddd' }}>05:00:00</td>
                  <td style={{ border: '1px solid #dddddd' }}>07:59:00</td>
                  <td style={{ border: '1px solid #dddddd' }}>600</td>
                </tr>
                <tr style={{ backgroundColor: 'white' }}>
                  <td style={{ border: '1px solid #dddddd' }}>&nbsp;</td>
                  <td style={{ border: '1px solid #dddddd' }}>{this.props.route.route_long_name} - {this.props.activeSchedule.description} - Dia</td>
                  <td style={{ border: '1px solid #dddddd' }}>&nbsp;</td>
                  <td style={{ border: '1px solid #dddddd' }}>&nbsp;</td>
                  <td style={{ border: '1px solid #dddddd' }}>08:00:00</td>
                  <td style={{ border: '1px solid #dddddd' }}>19:59:00</td>
                  <td style={{ border: '1px solid #dddddd' }}>360</td>
                </tr>
                <tr style={{ backgroundColor: 'white' }}>
                  <td style={{ border: '1px solid #dddddd' }}>&nbsp;</td>
                  <td style={{ border: '1px solid #dddddd' }}>{this.props.route.route_long_name} - {this.props.activeSchedule.description} - Noche</td>
                  <td style={{ border: '1px solid #dddddd' }}>&nbsp;</td>
                  <td style={{ border: '1px solid #dddddd' }}>&nbsp;</td>
                  <td style={{ border: '1px solid #dddddd' }}>20:00:00</td>
                  <td style={{ border: '1px solid #dddddd' }}>22:59:00</td>
                  <td style={{ border: '1px solid #dddddd' }}>600</td>
                </tr>
              </tbody>
            </table>
