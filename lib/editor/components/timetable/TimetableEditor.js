          ...
          {...this.props} />
        {
          ...
          <div style={{marginTop: "20px"}}>
            <Button onClick={() => {this.setState({showMultipleFrecuenciesSameCalendarExample: true})}} bsStyle="primary" style={{ marginBottom: "20px" }}>
              Mostrar ejemplo de multiples frecuencias con el mismo calendario
            </Button>
          </div>
        }
        {
          this.state.showMultipleFrecuenciesSameCalendarExample &&
          <div style={{backgroundColor: "silver", padding: "8px", marginBottom: "20px", marginTop: "20px"}}>
            <Button onClick={() => {this.setState({showMultipleFrecuenciesSameCalendarExample: false})}} bsStyle="primary" style={{ marginBottom: "20px" }}>
              Esconder ejemplo de multiples frecuencias con el mismo calendario
            </Button>
